...
class BuscarAPI:
    def __init__(self):
        self.url = requests.get(f'https://pokeapi.co/api/v2/pokemon/?limit=1&offset=20')
        ...
        for detalhe in urls_detalhes:
            ...
            self.poke['peso'] = acesso['weight'] * 0.1
            self.poke['altura'] = acesso['height'] * 0.1
    ...
    def pokemons_detalhes(self):
        for index in self.list_of_pokemons:
            ...
            print(f"\033[35mAltura\033[m: \033[32m{index['altura']:.1f}m\033[m") 
